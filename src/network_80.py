...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        #self.encoder = Encoder(hp.hidden_size)
    ...
    def forward(self, src, trg, pos_src, pos_trg):
        memory, c_mask, attns_enc = self.encoder.forward(src, pos_src)
        mel_output, postnet_output, attn_probs, attns_dec = self.decoder.forward(memory, trg, c_mask, pos_trg)
